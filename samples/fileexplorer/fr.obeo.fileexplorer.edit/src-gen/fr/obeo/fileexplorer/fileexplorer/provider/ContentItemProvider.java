...
/**
 * This is the item provider adapter for a {@link fr.obeo.fileexplorer.fileexplorer.Content} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						FileexplorerPackage.Literals.CONTENT__NAME, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Content_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Content_type_feature", "_UI_Content_type"),
						FileexplorerPackage.Literals.CONTENT__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addContainerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Content_container_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Content_container_feature",
								"_UI_Content_type"),
						FileexplorerPackage.Literals.CONTENT__CONTAINER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case FileexplorerPackage.CONTENT__NAME:
		case FileexplorerPackage.CONTENT__TYPE:
		case FileexplorerPackage.CONTENT__CONTAINER:
