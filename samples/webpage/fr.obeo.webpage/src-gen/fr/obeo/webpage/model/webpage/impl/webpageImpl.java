 ...
 * </p>
 * <ul>
 *   <li>{@link fr.obeo.webpage.model.webpage.impl.webpageImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.obeo.webpage.model.webpage.impl.webpageImpl#getDate <em>Date</em>}</li>
 * </ul>
 *
 * @generated
 */
public class webpageImpl extends MinimalEObjectImpl.Container implements webpage {
	...
	public void setDate(Calendar newDate) {
		...
		date = newDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebpagePackage.WEBPAGE__DATE, oldDate, date));
	}
